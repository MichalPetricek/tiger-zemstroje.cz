...
export default function Rental({
  ...
  const rentalPrices = [
    { period: "Den", price: "3 000 Kč", priceWithoutVat: "2 479 Kč bez DPH" },
    {
      period: "Víkend (Pá-Ne)",
      price: "6 500 Kč",
      priceWithoutVat: "5 372 Kč bez DPH",
    },
    {
      period: "Týden (7 dní)",
      price: "15 000 Kč",
      priceWithoutVat: "12 397 Kč bez DPH",
    },
    {
      period: "1 měsíc",
      price: "30 000 Kč",
      priceWithoutVat: "24 793 Kč bez DPH",
    },
    {
      period: "3 měsíce",
      price: "85 000 Kč",
      priceWithoutVat: "70 248 Kč bez DPH",
    },
    {
      period: "6 měsíců",
      price: "160 000 Kč",
      priceWithoutVat: "132 231 Kč bez DPH",
    },
    {
      period: "12 měsíců",
      price: "300 000 Kč",
      priceWithoutVat: "247 934 Kč bez DPH",
    },
  ];
    ...
    <div className="py-16 px-4">
      <div className="container mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-4xl lg:text-5xl font-bold mb-6">Pronájem</h1>
        </div>
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-muted-foreground">
                ...
                Výkonný a spolehlivý traktor ideální pro širokou škálu prací na
                farmě, zahradě či stavebním pozemku.
              </p>
            </div>
          ...
          <div className="space-y-8">
            ...
            <Card>
              <CardHeader>
                ...
                <p className="text-sm text-muted-foreground">
                  Ceny zahrnují DPH 21%. Konečná cena dle délky pronájmu a
                  požadavků.
                </p>
              </CardHeader>
              <CardContent>
              ...
              <CardContent>
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    ...
                    <span>
                      Vratná kauce: <strong>10 000 Kč</strong> (8 264 Kč bez
                      DPH)
                    </span>
                  </div>
                  <div className="flex items-center space-x-3">
              ...
              <CardContent>
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="flex items-start space-x-2">
                    ...
                    >
                      Souhlasím se zpracováním osobních údajů pro zpracování
                      tohoto dotazu a poskytnutí servisních služeb. Souhlas mohu
                      kdykoli odvolat.
                    </Label>
                  </div>
